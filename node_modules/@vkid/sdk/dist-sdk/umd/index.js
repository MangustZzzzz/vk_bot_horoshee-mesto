(function (global, factory) {
  ...
  var getVKIDUrl = function(module, params, config) {
      var queryParams = _object_spread_props$1(_object_spread$5({}, params), {
          v: VERSION,
          sdk_type: "vkid",
          app_id: config.app,
  ...
  var Widget = /*#__PURE__*/ function(Dispatcher) {
      ...
      function Widget() {
          ...
          var _this;
          _this = _super.call(this);
          _define_property$a(_assert_this_initialized$4(_this), "id", customAlphabet("qazwsxedcrfvtgbyhnujmikol", 6)());
     ...
     */ function onBridgeMessageHandler(event) {
          ...
          },
          {
              ...
              value: function getWidgetFrameSrc(config, params) {
                  var queryParams = _object_spread_props(_object_spread$2({}, params), {
  ...
  var _obj$6;
  var longLang = (_obj$6 = {}, _define_property$8(_obj$6, exports.Languages.RUS, "Войти c VK ID"), _define_property$8(_obj$6, exports.Languages.UKR, "Увійти з VK ID"), _define_property$8(_obj$6, exports.Languages.ENG, "Sign in with VK ID"), _define_property$8(_obj$6, exports.Languages.SPA, "Iniciar sesi\xf3n con VK ID"), _define_property$8(_obj$6, exports.Languages.GERMAN, "Mit VK-ID anmelden"), _define_property$8(_obj$6, exports.Languages.POL, "Wejdź z VK ID"), _define_property$8(_obj$6, exports.Languages.FRA, "Se connecter avec VK ID"), _define_property$8(_obj$6, exports.Languages.TURKEY, "VK ID aracılığıyla gir"), _obj$6);
  var _obj1$3;
  var shortLang = (_obj1$3 = {}, _define_property$8(_obj1$3, exports.Languages.RUS, "Продолжить"), _define_property$8(_obj1$3, exports.Languages.UKR, "Продовжити"), _define_property$8(_obj1$3, exports.Languages.ENG, "Continue"), _define_property$8(_obj1$3, exports.Languages.SPA, "Continuar"), _define_property$8(_obj1$3, exports.Languages.GERMAN, "Fortfahren"), _define_property$8(_obj1$3, exports.Languages.POL, "Kontynuuj"), _define_property$8(_obj1$3, exports.Languages.FRA, "Continuer"), _define_property$8(_obj1$3, exports.Languages.TURKEY, "Devam"), _obj1$3);
  ...
  var getOneTapTemplate = function(param) {
      var width = param.width, height = param.height, iframeHeight = param.iframeHeight, borderRadius = param.borderRadius, openFullAuth = param.openFullAuth, skin = param.skin, scheme = param.scheme, _param_lang = param.lang, lang = _param_lang === void 0 ? exports.Languages.RUS : _param_lang;
      return function(id) {
          var textIconLimit = 0;
          var textLongLimit = 0;
          ...
          spinnerEl.innerHTML = spinnerSvg$2;
  ...
  var OneTap = /*#__PURE__*/ function(Widget) {
      _inherits$2(OneTap, Widget);
      var _super = _create_super$2(OneTap);
      function OneTap() {
          _class_call_check$2(this, OneTap);
          var _this;
          _this = _super.apply(this, arguments);
          _define_property$7(_assert_this_initialized$2(_this), "vkidAppName", "button_one_tap_auth");
          return _this;
      }
      _create_class$2(OneTap, [
          {
              key: "onBridgeMessageHandler",
              value: function onBridgeMessageHandler(event) {
                  switch(event.handler){
                      ...
                      default:
                          {
                              _get$1(_get_prototype_of$2(OneTap.prototype), "onBridgeMessageHandler", this).call(this, event);
                              break;
                          }
                  }
              }
          ...
          },
          {
              ...
              value: function render(params) {
                  ...
                  var oneTapParams = {
                      style_height: ((_params_styles = params.styles) === null || _params_styles === void 0 ? void 0 : _params_styles.height) || defaultStylesParams$1.height,
                      style_border_radius: ((_params_styles1 = params.styles) === null || _params_styles1 === void 0 ? void 0 : _params_styles1.borderRadius) || defaultStylesParams$1.borderRadius,
                  ...
                  this.templateRenderer = getOneTapTemplate({
                      width: ((_params_styles2 = params.styles) === null || _params_styles2 === void 0 ? void 0 : _params_styles2.width) || defaultStylesParams$1.width,
                  ...
                  return _get$1(_get_prototype_of$2(OneTap.prototype), "render", this).call(this, _object_spread$1({
  ...
  var _obj$5;
  var SIGN_IN = (_obj$5 = {}, _define_property$6(_obj$5, exports.Languages.RUS, "Войти c VK ID"), _define_property$6(_obj$5, exports.Languages.UKR, "Увійти з VK ID"), _define_property$6(_obj$5, exports.Languages.ENG, "Sign in with VK ID"), _define_property$6(_obj$5, exports.Languages.SPA, "Iniciar sesi\xf3n con VK ID"), _define_property$6(_obj$5, exports.Languages.GERMAN, "Mit VK-ID anmelden"), _define_property$6(_obj$5, exports.Languages.POL, "Wejdź z VK ID"), _define_property$6(_obj$5, exports.Languages.FRA, "Se connecter avec VK ID"), _define_property$6(_obj$5, exports.Languages.TURKEY, "VK ID aracılığıyla gir"), _obj$5);
  var _obj1$2;
  var CONTINUE = (_obj1$2 = {}, _define_property$6(_obj1$2, exports.Languages.RUS, "Продолжить с VK ID"), _define_property$6(_obj1$2, exports.Languages.UKR, "Продовжити з VK ID"), _define_property$6(_obj1$2, exports.Languages.ENG, "Continue with VK ID"), _define_property$6(_obj1$2, exports.Languages.SPA, "Continuar con VK ID"), _define_property$6(_obj1$2, exports.Languages.GERMAN, "Mit VK-ID fortfahren"), _define_property$6(_obj1$2, exports.Languages.POL, "Kontynuuj z VK ID"), _define_property$6(_obj1$2, exports.Languages.FRA, "Continuer avec VK ID"), _define_property$6(_obj1$2, exports.Languages.TURKEY, "VK ID aracılığıyla devam et"), _obj1$2);
  var _obj2$2;
  var MAKE_ORDER = (_obj2$2 = {}, _define_property$6(_obj2$2, exports.Languages.RUS, "Оформить с VK ID"), _define_property$6(_obj2$2, exports.Languages.UKR, "Оформити з VK ID"), _define_property$6(_obj2$2, exports.Languages.ENG, "Order with VK ID"), _define_property$6(_obj2$2, exports.Languages.SPA, "Pedir con VK ID"), _define_property$6(_obj2$2, exports.Languages.GERMAN, "Mit VK-ID bestellen"), _define_property$6(_obj2$2, exports.Languages.POL, "Wypełnij z VK ID"), _define_property$6(_obj2$2, exports.Languages.FRA, "Commander avec VK ID"), _define_property$6(_obj2$2, exports.Languages.TURKEY, "VK ID aracılığıyla oluştur"), _obj2$2);
  ...
  var _obj$4;
  var SIGN_IN_TO_SERVICE = (_obj$4 = {}, _define_property$5(_obj$4, exports.Languages.RUS, "Войдите в\xa0сервис или\xa0зарегистрируйтесь"), _define_property$5(_obj$4, exports.Languages.UKR, "Увійдіть у\xa0сервіс або\xa0зареєструйтеся"), _define_property$5(_obj$4, exports.Languages.ENG, "Sign in to\xa0service or\xa0sign up"), _define_property$5(_obj$4, exports.Languages.SPA, "Acceder al\xa0servicio o\xa0registrarse"), _define_property$5(_obj$4, exports.Languages.GERMAN, "Melden Sie sich beim\xa0Dienst\xa0an oder registrieren Sie\xa0sich"), _define_property$5(_obj$4, exports.Languages.POL, "Wejdź do\xa0serwisu lub\xa0zarejestruj się"), _define_property$5(_obj$4, exports.Languages.FRA, "Connectez-vous au\xa0service ou\xa0inscrivez-vous"), _define_property$5(_obj$4, exports.Languages.TURKEY, "Hizmete\xa0girin yada\xa0oturum oluşturun"), _obj$4);
  var _obj1$1;
  var SIGN_IN_TO_ACCOUNT = (_obj1$1 = {}, _define_property$5(_obj1$1, exports.Languages.RUS, "Войдите в учётную запись {service}"), _define_property$5(_obj1$1, exports.Languages.UKR, "Увійдіть в обліковий запис {service}"), _define_property$5(_obj1$1, exports.Languages.ENG, "Sign in to\xa0{service} account"), _define_property$5(_obj1$1, exports.Languages.SPA, "Acceder a la cuenta\xa0{service}"), _define_property$5(_obj1$1, exports.Languages.GERMAN, "Melden Sie sich bei Ihrem\xa0{service}-Konto an"), _define_property$5(_obj1$1, exports.Languages.POL, "Wejdź na rachunek {service}"), _define_property$5(_obj1$1, exports.Languages.FRA, "Connectez-vous \xe0\xa0{service}"), _define_property$5(_obj1$1, exports.Languages.TURKEY, "{service} hesabına girin"), _obj1$1);
  var _obj2$1;
  var REGISTRATION_FOR_EVENT = (_obj2$1 = {}, _define_property$5(_obj2$1, exports.Languages.RUS, "Зарегистрируйтесь на\xa0мероприятие"), _define_property$5(_obj2$1, exports.Languages.UKR, "Зареєструйтеся на\xa0захід"), _define_property$5(_obj2$1, exports.Languages.ENG, "Sign up for\xa0event"), _define_property$5(_obj2$1, exports.Languages.SPA, "Registrarse en\xa0el\xa0evento"), _define_property$5(_obj2$1, exports.Languages.GERMAN, "Melden\xa0Sie\xa0sich f\xfcr\xa0die\xa0Veranstaltung\xa0an"), _define_property$5(_obj2$1, exports.Languages.POL, "Zarejestruj się na\xa0wydarzenie"), _define_property$5(_obj2$1, exports.Languages.FRA, "Inscrivez-vous \xe0\xa0l'\xe9v\xe9nement"), _define_property$5(_obj2$1, exports.Languages.TURKEY, "Eylemde\xa0kaydolun"), _obj2$1);
  var _obj3;
  var SUBMIT_APPLICATIONS = (_obj3 = {}, _define_property$5(_obj3, exports.Languages.RUS, "Подайте заявку с\xa0VK\xa0ID"), _define_property$5(_obj3, exports.Languages.UKR, "Подайте запит з\xa0VK\xa0ID"), _define_property$5(_obj3, exports.Languages.ENG, "Apply with\xa0VK\xa0ID"), _define_property$5(_obj3, exports.Languages.SPA, "Solicitar con\xa0VK\xa0ID"), _define_property$5(_obj3, exports.Languages.GERMAN, "Bewerben Sie mit\xa0VK-ID"), _define_property$5(_obj3, exports.Languages.POL, "Zł\xf3ż wniosek z\xa0VK\xa0ID"), _define_property$5(_obj3, exports.Languages.FRA, "Envoyez une\xa0demande avec\xa0VK\xa0ID"), _define_property$5(_obj3, exports.Languages.TURKEY, "VK\xa0ID\xa0yardımıyla başvuru g\xf6nderin"), _obj3);
  var _obj4;
  var MAKE_ORDER_WITH_SERVICE = (_obj4 = {}, _define_property$5(_obj4, exports.Languages.RUS, "Оформите заказ в\xa0{service} с\xa0VK\xa0ID"), _define_property$5(_obj4, exports.Languages.UKR, "Оформіть замовлення в\xa0{service} з\xa0VK\xa0ID"), _define_property$5(_obj4, exports.Languages.ENG, "Place order on\xa0{service} with\xa0VK\xa0ID"), _define_property$5(_obj4, exports.Languages.SPA, "Realizar pedido en\xa0{service} con\xa0VK\xa0ID"), _define_property$5(_obj4, exports.Languages.GERMAN, "Machen Sie eine\xa0Bestellung auf\xa0{service} mit\xa0VK-ID"), _define_property$5(_obj4, exports.Languages.POL, "Wypełnij zam\xf3wienie w\xa0{service} z\xa0VK\xa0ID"), _define_property$5(_obj4, exports.Languages.FRA, "Passez la\xa0commande sur\xa0{service} avec\xa0VK\xa0ID"), _define_property$5(_obj4, exports.Languages.TURKEY, "VK\xa0ID\xa0aracılığıyla {service} te sipariş oluşturun"), _obj4);
  var _obj5;
  var MAKE_ORDER_WITHOUT_SERVICE = (_obj5 = {}, _define_property$5(_obj5, exports.Languages.RUS, "Оформите заказ с\xa0VK\xa0ID"), _define_property$5(_obj5, exports.Languages.UKR, "Оформіть замовлення з\xa0VK\xa0ID"), _define_property$5(_obj5, exports.Languages.ENG, "Place order with\xa0VK\xa0ID"), _define_property$5(_obj5, exports.Languages.SPA, "Realizar pedido con\xa0VK\xa0ID"), _define_property$5(_obj5, exports.Languages.GERMAN, "Machen Sie eine\xa0Bestellung mit\xa0VK-ID"), _define_property$5(_obj5, exports.Languages.POL, "Wypełnij zam\xf3wienie z\xa0VK\xa0ID"), _define_property$5(_obj5, exports.Languages.FRA, "Passez la\xa0commande avec\xa0VK\xa0ID"), _define_property$5(_obj5, exports.Languages.TURKEY, "VK\xa0ID\xa0aracılığıyla sipariş oluşturun"), _obj5);
  ...
  var _obj$3;
  var DESCRIPTION = (_obj$3 = {}, _define_property$4(_obj$3, exports.Languages.RUS, "После этого вам станут доступны все возможности сервиса. Ваши данные будут надёжно защищены."), _define_property$4(_obj$3, exports.Languages.UKR, "Після цього вам стануть доступні всі можливості сервісу. Ваші дані будуть надійно захищені."), _define_property$4(_obj$3, exports.Languages.ENG, "Afterwards, you'll have access to\xa0all of\xa0the\xa0service's features. Your personal data will be carefully protected."), _define_property$4(_obj$3, exports.Languages.SPA, "Despu\xe9s, tendr\xe1s acceso a\xa0todas las funciones del\xa0servicio. Tus datos personales estar\xe1n cuidadosamente protegidos."), _define_property$4(_obj$3, exports.Languages.GERMAN, "Anschlie\xdfend stehen Ihnen alle Funktionen des Dienstes zur Verf\xfcgung. Ihre\xa0pers\xf6nlichen Daten werden sorgf\xe4ltig gesch\xfctzt."), _define_property$4(_obj$3, exports.Languages.POL, "Po tym wszystkie funkcje serwisu będą dostępne. Twoje dane będą dobrze chronione."), _define_property$4(_obj$3, exports.Languages.FRA, "Cela vous permettra d'avoir acc\xe8s \xe0\xa0toutes les\xa0fonctionnalit\xe9s du service. Vos donn\xe9es personnelles seront soigneusement prot\xe9g\xe9es."), _define_property$4(_obj$3, exports.Languages.TURKEY, "Bundan sonra hizmetin t\xfcm \xf6zellikleri kullanımınıza sunulacaktır. Verileriniz g\xfcvenilir bir şekilde korunacaktır."), _obj$3);
  ...
  var getFloatingOneTapTemplate = function(param) {
      var scheme = param.scheme, indent = param.indent, openFullAuth = param.openFullAuth, close = param.close, lang = param.lang, contentId = param.contentId, appName = param.appName;
      return function(id) {
          ...
          buttonSpinnerEl.innerHTML = spinnerSvg$1;
          var handleLoaded = function() {
  ...
  var FloatingOneTap = /*#__PURE__*/ function(Widget) {
      _inherits$1(FloatingOneTap, Widget);
      var _super = _create_super$1(FloatingOneTap);
      function FloatingOneTap() {
          _class_call_check$1(this, FloatingOneTap);
          var _this;
          _this = _super.apply(this, arguments);
          _define_property$3(_assert_this_initialized$1(_this), "vkidAppName", "floating_one_tap_auth");
          return _this;
      }
      _create_class$1(FloatingOneTap, [
          {
              key: "onBridgeMessageHandler",
              value: function onBridgeMessageHandler(event) {
                  var _this = this;
                  switch(event.handler){
                      ...
                      default:
                          {
                              _get(_get_prototype_of$1(FloatingOneTap.prototype), "onBridgeMessageHandler", this).call(this, event);
                              break;
                          }
                  }
              }
          ...
          },
          {
              ...
              value: function render(params) {
                  ...
                  return _get(_get_prototype_of$1(FloatingOneTap.prototype), "render", this).call(this, _object_spread({
                      container: document.body
                  }, queryParams));
              }
          }
  ...
  var _obj$2;
  var OAuthNameText = (_obj$2 = {}, _define_property$2(_obj$2, exports.OAuthName.OK, "OK"), _define_property$2(_obj$2, exports.OAuthName.MAIL, "Mail.ru"), _define_property$2(_obj$2, exports.OAuthName.VK, "VK ID"), _obj$2);
  ...
  var _obj$1;
  var linkTextLang = (_obj$1 = {}, _define_property$1(_obj$1, exports.Languages.RUS, "или войти через VK\xa0ID\xa0с использованием данных из\xa0сервиса"), _define_property$1(_obj$1, exports.Languages.UKR, "orsign in withVKID using information fromaservice"), _define_property$1(_obj$1, exports.Languages.ENG, "orsign in withVKID using information fromaservice"), _define_property$1(_obj$1, exports.Languages.SPA, "orsign in withVKID using information fromaservice"), _define_property$1(_obj$1, exports.Languages.GERMAN, "orsign in withVKID using information fromaservice"), _define_property$1(_obj$1, exports.Languages.POL, "orsign in withVKID using information fromaservice"), _define_property$1(_obj$1, exports.Languages.FRA, "orsign in withVKID using information fromaservice"), _define_property$1(_obj$1, exports.Languages.TURKEY, "orsign in withVKID using information fromaservice"), _obj$1);
  var _obj1, _obj2;
  var singleButtonText = (_obj2 = {}, _define_property$1(_obj2, exports.Languages.RUS, (_obj1 = {}, _define_property$1(_obj1, exports.OAuthName.OK, "Войти через OK"), _define_property$1(_obj1, exports.OAuthName.MAIL, "Войти с Почтой Mail.ru"), _define_property$1(_obj1, exports.OAuthName.VK, "Войти с VK ID"), _obj1)), _define_property$1(_obj2, exports.Languages.UKR, "Увійти з {provider}"), _define_property$1(_obj2, exports.Languages.ENG, "Sign in with {provider}"), _define_property$1(_obj2, exports.Languages.SPA, "Iniciar sesi\xf3n con {provider}"), _define_property$1(_obj2, exports.Languages.GERMAN, "\xdcber {provider} anmelden"), _define_property$1(_obj2, exports.Languages.POL, "Wejdź poprzez {provider}"), _define_property$1(_obj2, exports.Languages.FRA, "Connexion avec {provider}"), _define_property$1(_obj2, exports.Languages.TURKEY, "{provider}'den gir"), _obj2);
  ...
  var spinnerSvg = '\n  <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">\n    <path d="M14 22C13.4477 22 13 21.5523 13 21C13 20.4477 13.4477 20 14 20C17.3137 20 20 17.3137 20 14C20 10.6863 17.3137 8 14 8C10.6863 8 8 10.6863 8 14C8 14.6472 8.10214 15.2793 8.3002 15.8802C8.4731 16.4047 8.18807 16.9701 7.66355 17.143C7.13902 17.3159 6.57365 17.0308 6.40074 16.5063C6.13628 15.7041 6 14.8606 6 14C6 9.58172 9.58172 6 14 6C18.4183 6 22 9.58172 22 14C22 18.4183 18.4183 22 14 22Z" fill="currentColor"/>\n  </svg>\n';
  var _obj;
  var OAuthIconMap = (_obj = {}, _define_property(_obj, exports.OAuthName.VK, function(size) {
  ...
  }), _define_property(_obj, exports.OAuthName.OK, function(size) {
  ...
  }), _define_property(_obj, exports.OAuthName.MAIL, function(size) {
  ...
  var getOAuthListTemplate = function(params) {
      return function(id) {
          ...
          var handleLoaded = function() {
              var textDiv = document.querySelector(".VkIdSdk_oauth_button_text");
              var oauthItemDiv = document.querySelector(".VkIdSdk_oauth_item");
              ...
              if (shouldHideText) {
                  ...
                  (_document_querySelector = document.querySelector(".VkIdSdk_oauth_list")) === null || _document_querySelector === void 0 ? void 0 : _document_querySelector.removeAttribute("data-single-mode");
              }
          };
          if (document.readyState === "loading") {
              document.addEventListener("DOMContentLoaded", handleLoaded);
