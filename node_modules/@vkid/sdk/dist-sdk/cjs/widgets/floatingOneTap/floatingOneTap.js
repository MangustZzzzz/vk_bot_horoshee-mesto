...
var events$2 = require('../agreementsDialog/events.js');
    ...
    _create_class(FloatingOneTap, [
        {
            ...
            value: function onBridgeMessageHandler(event) {
                ...
                switch(event.handler){
                    case events$1.WidgetEvents.RESIZE:
                        {
        ...
        },
        {
            ...
            value: function createAgreementsDialogWidget() {
                ...
                var acceptHandler = function(event) {
                    ...
                    agreementsDialog$1.off(events$2.AgreementsDialogInternalEvents.ACCEPT, acceptHandler);
                    agreementsDialog$1.close();
                };
                agreementsDialog$1.on(events$2.AgreementsDialogInternalEvents.ACCEPT, acceptHandler);
        ...
        },
        {
            ...
            value: function render(params) {
                ...
                var queryParams = {
                    ...
                    content_id: ((_params3 = params) === null || _params3 === void 0 ? void 0 : _params3.contentId) || types$2.FloatingOneTapContentId.SIGN_IN_TO_SERVICE
                };
