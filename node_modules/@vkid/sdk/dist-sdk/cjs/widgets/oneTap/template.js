...
var getOneTapTemplate = function(param) {
    var width = param.width, height = param.height, iframeHeight = param.iframeHeight, borderRadius = param.borderRadius, openFullAuth = param.openFullAuth, skin = param.skin, scheme = param.scheme, _param_lang = param.lang, lang$1 = _param_lang === void 0 ? types.Languages.RUS : _param_lang;
    return function(id) {
        var textIconLimit = 0;
        var textLongLimit = 0;
