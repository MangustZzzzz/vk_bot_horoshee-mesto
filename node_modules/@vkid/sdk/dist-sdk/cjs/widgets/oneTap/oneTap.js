    ...
    _create_class(OneTap, [
        {
            ...
            value: function onBridgeMessageHandler(event) {
                switch(event.handler){
                    ...
                    case events.OneTapInternalEvents.SHOW_AGREEMENTS_DIALOG:
                        {
            ...
            value: function createAgreementsDialogWidget() {
                ...
                var acceptHandler = function(event) {
                    _this.bridge.sendMessage({
                        handler: events.OneTapInternalEvents.START_AUTHORIZE,
                        params: event.params
                    });
                    agreementsDialog$1.off(events$1.AgreementsDialogPublicEvents.ACCEPT, acceptHandler);
                    agreementsDialog$1.close();
                };
                agreementsDialog$1.on(events$1.AgreementsDialogPublicEvents.ACCEPT, acceptHandler);
